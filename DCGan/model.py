...
"""
    the goal with the discriminator is to have a probability [0,1] to 
    determine whether the image is fake or not    
"""
class Discriminator(nn.Module):
    def __init__(self, channel_img, features_d):
        super(Discriminator, self).__init__()
        self.disc =  nn.Sequential(
            # Input image : N x channels_image  64 x 64
            nn.Conv2d(
...
def test():
    ...
    disc = Discriminator(channel_img = in_channels, features_d= 8)
